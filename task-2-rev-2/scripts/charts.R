...
{
  new_ra[lotss_num]<-abs(lotss_neightbour_results_nearest[lotss_num,"gaia_converted_ra"])
  new_dec[lotss_num]<-abs(lotss_neightbour_results_nearest[lotss_num,"gaia_converted_dec"])
}
