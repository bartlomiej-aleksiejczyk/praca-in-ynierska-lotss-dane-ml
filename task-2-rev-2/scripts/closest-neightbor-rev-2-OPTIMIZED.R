...
lotss_neightbour_results_nearest <- cbind(appended_dates_df,closest_neightbour_id,closest_neightbour_ra, gaia_converted_ra, closest_neightbour_dec, gaia_converted_dec, closest_neightbour_dist_sec)
